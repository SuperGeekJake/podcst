...
export const VolumeUpSvg: Component<{ class?: string }> = (props) => (
  <svg
    class={props.class}
    width="24px"
    height="24px"
...
export const VolumeDownSvg: Component<{ class?: string }> = (props) => (
  <svg
    class={props.class}
    width="24px"
    height="24px"
...
export const VolumeOffSvg: Component<{ class?: string }> = (props) => (
  <svg
    class={props.class}
    width="24px"
    height="24px"
